...
python3 real_onlineAlgo.py -S _zero_utl_unifEVsameBid_tau2  -Y [0.5,0.75,1,1.25,1.5] -W  0 -E 104 -G 0.01 -B 1 -K 0.2 -T 2 -P 75 -I bids_no_solar_2019_few_sample/ -D sameBid_realVisits/ &&  echo "unifFewBid Tau2 75 done"  &
python3 real_onlineAlgo.py -S _zero_utl_unifEVsameBid_tau3  -Y [0.5,0.75,1,1.25,1.5] -W  0 -E 131 -G 0.01 -B 1 -K 0.2 -T 3 -P 75 -I bids_no_solar_2019_few_sample/ -D sameBid_realVisits/ &&  echo "unifFewBid Tau3 75 done"  &
