...
from nov2g_funcOnlineAlgo import create_ev_dict, EV, get_connected_ev, charge_EV, charge_v2g_EV, discharge_v2g_EV, get_types_and_possible_discharge_e, get_online_alg_result_mc_simul, create_ev_dict_from_df
    ...
    try: 
        ...
        for perc in (perc_allow_EV_discharge):
            ...
            for run, seed in enumerate(seed_lst):
                ...
                for day_no, date in enumerate(tqdm(unique_dates, total=len(unique_dates), desc = f"{TAU} in {res_dir}")):
