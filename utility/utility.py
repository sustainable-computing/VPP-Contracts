...
def save_result(result_loc, result_dict):
    with open(result_loc, "wb") as outfile:
...
# NOT NEEDED BELOW LINES

#def save_dict(file_name, dict_, save_in_pickle=False):
#    if save_in_pickle==False:
#        f = open(file_name, 'w')
#        f.write(str(dict_))
#        f.close()
#    else:
...
#def load_dict(file_name, load_in_pickle=True):
#    if load_in_pickle==False:
#        f = open(file_name, 'r')
#        data = f.read()
#        f.close()
